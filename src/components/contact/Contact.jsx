...
<div className="flex flex-row flex-wrap justify-around mt-15 md:mt-20 font-serif">
  ...
  <div className="md:h-auto h-65  md:mt-5 mt-15 flex flex-col flex-wrap">
    ...
    <div className="flex flex-col text-[#08034e] flex-wrap font-bold ">
      ...
      <input className="border-black   rounded-md border-2 h-7 w-50 placeholder-gray-800 md:h-10 px-2 md:w-120" type="text"  placeholder='Enter Your Name'
      />
      <input  className="border-black  placeholder-gray-800 rounded-md  mt-2 border-2  h-7 w-50 md:h-9 px-2 md:w-120" type="text" placeholder="Enter Your Email" />
      <input  className="border-black placeholder-gray-800 rounded-md mt-2 border-2  h-7 w-50 md:h-9 md:w-120 px-2" type="text" placeholder='Enter Your Subject'/>
      <textarea className='border-black  mt-2 h-10 w-50 md:h-30 md:w-120 border-2 text-left align-top pt-2 px-2 borderr-gray-300 rounded-md placeholder-gray-800 resize-none'placeholder='Enter Your Message' ></textarea>
